...
unlocked to sign the Violetcoin-Qt.app bundle.
...
allowing somebody to distribute a Violetcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the violetcoin-qt.exe file inside the installer had not been tampered with.
